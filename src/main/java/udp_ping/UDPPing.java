...
public class UDPPing extends Object {
    ...
    public void startThreads(String args[]){
        ...
        /*
         * Sind beim Programmstart genau zwei Argumente �bergeben wordeb (IP-Adresse und Port),
         ...
         * Demnach �berschreiben beide Klassen die vererbte Methode run(). Durch den Aufruf von
    ...
    */
    public static void main (String args[]) {
        ...
        /*
         * Sind 2 oder 3 Argumente angegeben wird das Programm ausgef�hrt,
