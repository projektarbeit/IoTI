...
public class DatagramSender extends java.lang.Thread {
    ...
    public void run()
    {
        ...
        while(loop)
        {
            ...
            try
            {
                ...
                //Ist die L�nge des Pakets gr��er 0, enth�lt es Inhalt und ist somit g�ltig
    ...
    protected DatagramPacket nextPacket()
    {
         ...
         * ein Byte-Array. Per return wird das vorbereitete Packet zur�ckgegeben 
         * und abgeschickt. 
         * Siehe dazu Zeile 47
         * 
         */       
    ...
    protected void handlePacket(DatagramPacket packet)
    {
        ...
        /*
         * F�r ein eingehendes Paket muss - analog zum ausgehenden Paket - ein ByteArrayInputStream
         * sowie der dazugeh�rige DataInputStream angelegt werden. Das ByteArray wird wie beim Senden
         * auch mit dem DataInputStream verkn�pft.
         * 
         */
    ...
    //Diese Funktion l�sst das Programm 1 Sekunde warten.
